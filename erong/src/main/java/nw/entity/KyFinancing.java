 ...
 */
@Entity
@Table(name = "ky_financing", catalog = "erong")
public class KyFinancing implements java.io.Serializable {
	...
	/** full constructor */
	public KyFinancing(String name, String province, String city,
