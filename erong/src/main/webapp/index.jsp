...
<div class="header header-bg">
    ...
    <div id="main-nav">
        <ul>
            ...
            <li class="mainNav-item" nav="我要借款"><a id='a_gojiekuan' href="Loan" action-data="window_4||ui-window-1||400||250" class="openWindow">
                我要借款</a></li>
    ...
    <div class="banner">
            <div class="banner-item" style="left: 0; display: block;">
                <a href="javascript:void(0)" title="">
                    <div class="inner" style="background: url(https://files.wefax.cn/Upload/YaoDu/0/20141225/0-20141225-1743296526-0.jpg) center 0 no-repeat;">
                    </div>
                </a>
            </div>
            <div class="banner-item" style="left: 0; display: none;">
                <a href="javascript:void(0)" title="">
                    <div class="inner" style="background: url(https://files.wefax.cn/Upload/YaoDu/0/20141128/0-20141128-1615489254-0.jpg) center 0 no-repeat;">
                    </div>
                </a>
            </div>
            <div class="banner-item" style="left: 0; display: none;">
                <a href="javascript:void(0)" title="首页焦点图">
                    <div class="inner" style="background: url(https://files.wefax.cn/Upload/YaoDu/0/20141031/0-20141031-1555358182-0.jpg) center 0 no-repeat;">
                    </div>
                </a>
            </div>
        <div class="num">
                 ...
                 <div class="mod-wrap mod-hot-news">
                      <div class="mod-contnet">
                        <ul class="mod-list news-list">
                            ...
                            <li><a href="javascript:void(0)" class="openWindow" action-data="win_GongGao||ui-window-1||400||250">
                                <b>生钱树投资理财平台温馨说明</b> </a><span class="news-time">2014-10-30</span><img src="content/images/icon_new.gif" title="" alt="" />
                               </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="mod-wrap mod-totalNumber" ng-controller="summary">
                    <p>
                        ...
                        <span class="cell-num">参与投标人数：<b>{{entrynum}}人</b></span> <a href="javascript:void(0)"
                            class="cell-button" open_win="win_Intention" open_win_position="0">我有投资意向</a>
                    </p>
                </div>
            </div>
            <!--统计数字结束-->
                    ...
                    <div class="mod-wrap mod-project">
                        ...
                        <div class="mod-contnet">
                            <ul class="tap-label project-tab">
                                <li class="current" value="1"><a href="javascript:void(0)" class="jieshi" alt="平台所有项目均由尧都农商银行推荐，并对融资方信息进行审核。">
                                    银行项目</a></li>
                                
                            </ul>
                                <ul style="display: block" ng-controller="p2pList" class="labelContent project-list" id="labelContent" >
                                        <li ng-repeat="item in items">
                                            <div class="project-title" title="{{item.text}}【{{item.id}}】">
                                                <a class="ui-icon-bank" href="">
                                                    <img alt="" src="content/images/{{item.image}}" name="" width="65px" height="60px" /></a>
                                                <h3>
...
<div class="prompt_box" id="win_Intention" style="display: none;">
    <div class="prompt_inner ck_1 ui-window-1" style="width: 360px; height: 400px; left: -180px;
        top: -200px;">
        <h3 class="title">
            <span class="ico_1">出资意向征集</span><a href="javascript:void(0)" class="close" close-ui="win_Intention"></a></h3>
        <div class="content">
            <div class="hk_list" id="hklist">
                <table border="0" cellspacing="0" cellpadding="0" class="table_5">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="txtExpectYearInterest" rtip="请输入期望年化收益率" size="20" class="textFild mR" />
                            %以上
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="content">
            <table width="700" border="0" cellspacing="0" cellpadding="0" class="calculator-add">
                ...
                <tr>
                    ...
                    <td align="left" valign="middle">
                        <input type="text" id="txtAgainAccountNo" onpaste="return false" oncontextmenu="return false"
                            size="20" />
                ...
                <tr>
                    ...
                    <td align="left" valign="middle">
                        <select style="width: 255px;" id="ddlBankName" class="f-left">
                            <option value='100' text='中国邮政储蓄银行' selected='selected'>中国邮政储蓄银行</option><option value='102' text='中国工商银行' selected='selected'>中国工商银行</option><option value='103' text='中国农业银行' selected='selected'>中国农业银行</option><option value='104' text='中国银行' selected='selected'>中国银行</option><option value='105' text='中国建设银行' selected='selected'>中国建设银行</option><option value='301' text='交通银行' selected='selected'>交通银行</option><option value='302' text='中信银行' selected='selected'>中信银行</option><option value='303' text='中国光大银行' selected='selected'>中国光大银行</option><option value='304' text='华夏银行' selected='selected'>华夏银行</option><option value='305' text='中国民生银行' selected='selected'>中国民生银行</option><option value='306' text='广发银行' selected='selected'>广发银行</option><option value='307' text='平安银行' selected='selected'>平安银行</option><option value='308' text='招商银行' selected='selected'>招商银行</option><option value='309' text='兴业银行' selected='selected'>兴业银行</option><option value='310' text='上海浦东发展银行' selected='selected'>上海浦东发展银行</option><option value='422' text='河北银行' selected='selected'>河北银行</option><option value='440' text='徽商银行' selected='selected'>徽商银行</option><option value='1434' text='尧都农村商业银行' selected='selected'>尧都农村商业银行</option>
                        </select>
                        ...
                        <div class="searchSelet2" id="searchSelet" style="">
                            ...
                            <div class="txtList" id="txtList" style="display: none;">
                                <div class="kk">
                                    ...
                                    <div class="search-01">
                                        <div>
                                            <input type="text" class="input-1" id="ddltxtkeyword" value="请输入关键字搜索" defaulttext="请输入关键字搜索" />
                                            <input type="button" class="input-2" onclick="branchbank(true);" style="cursor: pointer;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="prompt_box" id="rzsq" style=" display:none">
    <div class="prompt_inner ck_1 ui-window-1">
        <h3 class="title">
            <span class="ico_1">融资申请登记</span><a href="javascript:void(0)" class="close" onclick="initDivStatus()"></a></h3>
            ...
            <div id="divFinancingIntentionApply">
                <table class="table-yxdj" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="td-2">
                            <textarea cols="1" rows="2" id="txtFinancingPurposes" class="textFild" onblur="initFinancingPurposes(this)"
                    ...
                    <tr>
                        <td colspan="2" class="td-4">
                            <input id="btnSubmitIntentionApply" type="button" value="提交" onclick="ValidateInputSubmit()" />
                        </td>
                    </tr>
                </table>
            </div>
...
<div id="divQQbox" class="advisory" >
  <div class="rzsq-kf openWindow"  open_win="rzsq"  action-data="rzsq||ui-window-1||480||400||canDrag||absolute||inIframe" style="cursor: pointer;">
...
<div style="z-index: 10000; top: 100px; display: none;" class="prompt_box" id="Borrowservice">
    <div style="width: 740px; left: -370px; display: block;" class="prompt_inner">
        <h3 class="title">
            <span class="ico_3">尧都农商银行提醒您</span><a class="close" onclick="javascript:$('#Borrowservice').hide();$('.blackBg').hide();"
...
<div style="width: 440px;left:-220px;" class="prompt_inner ck_1">
    <h3 class="title">
        <span class="icon_2">${TryStr(title,"系统提示")}</span><a class="close" id="opwin_btn_close" href="javascript:void(0)"></a></h3>
    <div class="bank-alter-text">
